...
module.exports = function () {
    WiFiAllocation.deployed().then(instance=> {
        web3.eth.getAccounts().then(accounts=> {
            ...
            instance.uponConnection(30,30,0, {from:accounts[1], gas:3000000, value:1000000000}).then(() => {
                instance.uponConnection(10, 10, 0, {from: accounts[2], gas: 3000000, value: 1000000000});
            });
        });
    });
};